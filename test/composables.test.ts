...
test(usesPluginClient, "getAllByIDs", useAllPrismicDocumentsByIDs, [
	["qux", "quux"],
]);
...
test(usesPluginClient, "getByTags", usePrismicDocumentsByTags, [
	["qux", "quux"],
]);
test(usesPluginClient, "getAllByTags", useAllPrismicDocumentsByTags, [
	["qux", "quux"],
]);
...
test(usesProvidedClient, "getByIDs", usePrismicDocumentsByIDs, [
	["qux", "quux"],
]);
test(usesProvidedClient, "getAllByIDs", useAllPrismicDocumentsByIDs, [
	["qux", "quux"],
]);
...
test(usesProvidedClient, "getByTags", usePrismicDocumentsByTags, [
	["qux", "quux"],
]);
test(usesProvidedClient, "getAllByTags", useAllPrismicDocumentsByTags, [
	["qux", "quux"],
]);
...
test(supportsParams, "getAllByIDs", useAllPrismicDocumentsByIDs, [
	["qux", "quux"],
]);
...
test(supportsParams, "getAllByTags", useAllPrismicDocumentsByTags, [
	["qux", "quux"],
]);
...
test(watchesReactiveParams, "getByIDs", usePrismicDocumentsByIDs, [
	["qux", "quux"],
]);
test(watchesReactiveParams, "getAllByIDs", useAllPrismicDocumentsByIDs, [
	["qux", "quux"],
]);
test(watchesReactiveParams, "getByUID", usePrismicDocumentByUID, [
	"qux",
	"quux",
]);
...
test(watchesReactiveParams, "getAllByType", useAllPrismicDocumentsByType, [
	"qux",
]);
test(watchesReactiveParams, "getByTag", usePrismicDocumentsByTag, ["qux"]);
test(watchesReactiveParams, "getAllByTag", useAllPrismicDocumentsByTag, [
	"qux",
]);
test(watchesReactiveParams, "getByTags", usePrismicDocumentsByTags, [
	["qux", "quux"],
]);
test(watchesReactiveParams, "getAllByTags", useAllPrismicDocumentsByTags, [
	["qux", "quux"],
]);
...
test(providesErrorStateOnError, "getByIDs", usePrismicDocumentsByIDs, [
	["qux", "quux"],
]);
test(providesErrorStateOnError, "getAllByIDs", useAllPrismicDocumentsByIDs, [
	["qux", "quux"],
]);
test(providesErrorStateOnError, "getByUID", usePrismicDocumentByUID, [
	"qux",
	"quux",
]);
test(providesErrorStateOnError, "getSingle", useSinglePrismicDocument, ["qux"]);
test(providesErrorStateOnError, "getByType", usePrismicDocumentsByType, [
	"qux",
]);
test(providesErrorStateOnError, "getAllByType", useAllPrismicDocumentsByType, [
	"qux",
]);
test(providesErrorStateOnError, "getByTag", usePrismicDocumentsByTag, ["qux"]);
test(providesErrorStateOnError, "getAllByTag", useAllPrismicDocumentsByTag, [
	"qux",
]);
test(providesErrorStateOnError, "getByTags", usePrismicDocumentsByTags, [
	["qux", "quux"],
]);
test(providesErrorStateOnError, "getAllByTags", useAllPrismicDocumentsByTags, [
	["qux", "quux"],
]);
