...
describe("renders a width-based srcset", () => {
	...
	it("with plugin's default widths if widths is `defaults`", (ctx) => {
		...
		expect(wrapper.html()).toMatchInlineSnapshot(
			`"<img src="https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=2560&amp;h=1705&amp;fit=crop&amp;sat=100" srcset="https://images.unsplash.com/photo-1441974231531-c6227db76b6e?fit=crop&amp;sat=100&amp;width=400 400w, https://images.unsplash.com/photo-1441974231531-c6227db76b6e?fit=crop&amp;sat=100&amp;width=500 500w, https://images.unsplash.com/photo-1441974231531-c6227db76b6e?fit=crop&amp;sat=100&amp;width=600 600w" alt="Sed arcu non odio euismod lacinia at">"`,
		)
	})
	...
	it("with the field's responsive views if widths is `thumbnails`", (ctx) => {
		...
		expect(wrapper.html()).toMatchInlineSnapshot(
			`"<img src="https://images.unsplash.com/photo-1497436072909-60f360e1d4b1?w=2560&amp;h=1440&amp;fit=crop&amp;sat=100" srcset="https://images.unsplash.com/photo-1497436072909-60f360e1d4b1?fit=crop&amp;sat=100&amp;width=2560 2560w, https://images.unsplash.com/photo-1446329813274-7c9036bd9a1f?fit=crop&amp;sat=100&amp;width=6000 6000w, https://images.unsplash.com/reserve/HgZuGu3gSD6db21T3lxm_San%20Zenone.jpg?fit=crop&amp;sat=100&amp;width=6373 6373w, https://images.unsplash.com/reserve/HgZuGu3gSD6db21T3lxm_San%20Zenone.jpg?fit=crop&amp;sat=100&amp;width=6373 6373w" alt="Est sit amet facilisis magna etiam">"`,
		)
	})
})
